...
CHEMLAYOUT_SETTINGS::CHEMLAYOUT_SETTINGS() :
        APP_SETTINGS_BASE( "chemlayout" ),
        m_System( "system" ),
        m_Window( "window" ),
        m_General( "general" )
{
    m_params.emplace_back( new PARAM<wxString>( "project.last_reactor_lib_dir",
            &m_lastLibDir, "" ) );
...
bool CHEMLAYOUT_SETTINGS::MigrateFromLegacy( wxConfigBase* aLegacyConfig )
{
