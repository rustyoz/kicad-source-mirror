...
/**
 * Main application class for the Chemical Reactor Layout editor
 */
class CHEM_LAYOUT_APP : public wxApp
{
public:
    CHEM_LAYOUT_APP() {}
    ...
    {
        CHEM_LAYOUT_FRAME* frame = new CHEM_LAYOUT_FRAME( nullptr, nullptr );
        SetTopWindow( frame );
        frame->Show( true );
...
wxIMPLEMENT_APP( CHEM_LAYOUT_APP );

/**
 * KIFACE_I implementation for the Chemical Reactor Layout editor
 */
...
static struct IFACE : public KIFACE_I
{
                            ...
                            int aCtlBits = 0 ) override
    {
        ...
        case FRAME_CHEM_LAYOUT:
            {
                CHEM_LAYOUT_FRAME* frame = new CHEM_LAYOUT_FRAME( aKiway, aParent );
                return frame;
            }
            break;
...
static KIFACE_I& Kiface() { return CHEMLAYOUT::kiface; }
