...
// For information, the main classes hierarchy for chemlayout is:
//
// CHEM_EDIT_FRAME -> KIWAY_PLAYER
// CHEM_EDIT_FRAME has a TOOL_MANAGER
// CHEM_EDIT_FRAME has a CHEM_PLANT

CHEM_EDIT_FRAME::CHEM_EDIT_FRAME( KIWAY* aKiway, wxWindow* aParent ) :
        KIWAY_PLAYER( aKiway, aParent, CHEMLAYOUT::FRAME_CHEM_LAYOUT, wxT( "ChemLayout" ),
                     ...
                     wxDEFAULT_FRAME_STYLE | wxWANTS_CHARS, GetCanvasType() )
{
    ...
    // Create the plant layout view
    m_plant = new CHEM_PLANT( this );

    // Create and initialize the tool manager
    m_toolManager = new TOOL_MANAGER;
    m_toolManager->SetEnvironment( m_plant, nullptr, nullptr, this );
...
{
    return &static_cast<CHEMLAYOUT_SETTINGS*>( aCfg )->m_Window;
}


CHEMLAYOUT_SETTINGS& CHEM_EDIT_FRAME::Settings() const
{
    return Kiway().CommonSettings<CHEMLAYOUT_SETTINGS>();
}
...
void CHEM_EDIT_FRAME::reCreateMenuBar()
{
    ...
    fileMenu->Append( wxID_NEW, _( "&New Chemical Plant Layout...\tCtrl+N" ) );
    fileMenu->Append( wxID_OPEN, _( "&Open Chemical Plant Layout...\tCtrl+O" ) );
    ...
    placeMenu->Append( ID_PLACE_REACTOR, _( "Place &Reactor...\tR" ) );
    placeMenu->Append( ID_PLACE_VESSEL, _( "Place &Vessel...\tV" ) );
    placeMenu->Append( ID_PLACE_PIPE, _( "Place &Pipe\tP" ) );
    placeMenu->Append( ID_PLACE_PUMP, _( "Place P&ump\tU" ) );
    placeMenu->Append( ID_PLACE_VALVE, _( "Place Val&ve\tA" ) );
    placeMenu->Append( ID_PLACE_SENSOR, _( "Place &Sensor\tS" ) );
    placeMenu->Append( ID_PLACE_TEXT, _( "Place &Text\tT" ) );
    
    // Help menu
    wxMenu* helpMenu = new wxMenu;
    helpMenu->Append( wxID_HELP, _( "Chemical Reactor Layout &Help" ) );
    helpMenu->Append( wxID_ABOUT, _( "&About ChemLayout" ) );
