...
/**
 * Main editing frame for chemical reactor layouts
 */
...
public:
    ...
    static const wxChar* GetCanvasType() { return wxT( "chem_layout_canvas" ); }
    ...
    /**
     * Return the CHEMLAYOUT_SETTINGS for this project
     */
    CHEMLAYOUT_SETTINGS& Settings() const;
...
private:
    ...
    /**
     * Create and show the chemical reactor layout canvas
     */
    void createCanvas();
