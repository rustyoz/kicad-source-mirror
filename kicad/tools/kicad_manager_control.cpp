...
void KICAD_MANAGER_CONTROL::setTransitions()
{
    ...
    Go( &KICAD_MANAGER_CONTROL::ShowPlayer,      KICAD_MANAGER_ACTIONS::editChemSchema.MakeEvent() );
    Go( &KICAD_MANAGER_CONTROL::ShowPlayer,      KICAD_MANAGER_ACTIONS::editChemLayout.MakeEvent() );
